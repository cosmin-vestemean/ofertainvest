...
exec sp_rename 'CCCMATRETETE.CANTITATEUNITARA',
'CANTTOTAL',
'COLUMN';
exec sp_rename 'CCCMATRETETE.PONDEREDECONT',
'CANTUNIT',
'COLUMN';
exec sp_rename 'CCCMATRETETE.PONDERENORMA',
'CANTREAL',
'COLUMN';
ALTER TABLE CCCMATRETETE
ADD CANTREALUNIT FLOAT;
ALTER TABLE CCCMATRETETE
ADD NORMUNITMAN FLOAT;
ALTER TABLE CCCMATRETETE
ADD TOTALOREMAN FLOAT;
ALTER TABLE CCCMATRETETE
ADD PONNORMMAN FLOAT;
...
from cccmatinstante a
	...
	inner join cccoferteweblinii c on (a.cccoferteweblinii = c.cccoferteweblinii)
	inner join cccoferteweblinii d on (b.cccoferteweblinii = d.cccoferteweblinii);
alter table CCCMATINSTANTE
ADD ISARTOF SMALLINT NOT NULL DEFAULT 0;
...
create table CCCPLANIFICARILINII (
	CCCPLANIFICARILINII INT NOT NULL PRIMARY KEY IDENTITY(1, 1),
	CCCPLANIFICARI INT NOT NULL,
	CCCOFERTEWEB INT NOT NULL,
	CCCANTEMASURATORI INT NOT NULL,
	CANTITATE FLOAT NOT NULL,
	DATASTART DATETIME,

      ...
      for (var j = 0; j < reteta.length; j++) {
        ...
        for (let n = 0; n < temps.length; n++) {
          var activit = {
            ...
            CANTITATE_FL: 0,
            VARIATII: {OFINIT: [], AMTEMASURATORI: [], AFL: [], NR: [], NCS: [] }, //{ FINDOC: 124453, MTRLINES: 2, CANTITATE: -10, DOCCLIENT: {DOC:'DISP SANT', DATA: 20240611} }, { FINDOC: 124453, MTRLINES: 2, CANTITATE: 3, DOCCLIENT: {DOC:'DISP SANT', DATA: 20240611} }

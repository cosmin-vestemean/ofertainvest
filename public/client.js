...
import { S1_populateSelects, S1_InsertDocument, S1_getValFromQuery } from './S1.js';
...
async function saveOferta() {
  ...
  var findoc = 0
  findoc = S1_getValFromQuery("select ident_current('findoc') + ident_incr('findoc')")
  ...
  S1_InsertDocument(jsonToSend, btn_oferta)
}

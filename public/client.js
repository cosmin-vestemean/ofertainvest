...
async function salveazaOfertaInDB(ds, optimal_ds) {
  let sqlList = []
  ...
  // Insert new records from optimal_ds into CCCOFERTEWEBLINII
  optimal_ds.forEach((item) => {
    sqlList.push(
      `INSERT INTO CCCOFERTEWEBLINII (CCCOFERTEWEB, WBS, GRUPARE_ART_OF, DENUMIRE_ART_OF, SERIE_ART_OF, TIP_ART_OF, SUBTIP_ART_OF, NIVEL_OF_1, NIVEL_OF_2, NIVEL_OF_3, NIVEL_OF_4, NIVEL_OF_5, NIVEL_OF_6, NIVEL_OF_7, NIVEL_OF_8, NIVEL_OF_9, NIVEL_OF_10, UM_ART_OF, CANT_ART_OF, COST_UNTR_MTRL_ART_OF, COST_UNTR_MAN_ART_OF, COST_UNTR_UTL_ART_OF, COST_UNTR_TRNS_ART_OF, NORMA_UNTR_ORE_MAN_ART_OF, COST_UNTR_ART_OF, COST_TOTAL_MTRL_ART_OF, COST_TOTAL_MAN_ART_OF, COST_TOTAL_UTL_ART_OF, COST_TOTAL_TRNS_ART_OF, COST_TOTAL_ART_OF, TOTAL_ORE_MAN_ART_OF, PRET_UNTR_MTRL_ART_OF, PRET_UNTR_MAN_ART_OF, PRET_UNTR_UTL_ART_OF, PRET_UNTR_TRNS_ART_OF, PRET_UNTR_ART_ART_OF, PRET_TOTAL_MTRL_ART_OF, PRET_TOTAL_MAN_ART_OF, PRET_TOTAL_UTL_ART_OF, PRET_TOTAL_TRNS_ART_OF, PRET_TOTAL_ART_ART_OF) VALUES ((SELECT CCCOFERTEWEB FROM CCCOFERTEWEB WHERE PRJC = ${contextOferta.PRJC}), '${item.WBS}', '${item.GRUPARE_ARTICOL_OFERTA}', '${item.DENUMIRE_ARTICOL_OFERTA}', '${item.SERIE_ARTICOL_OFERTA}', '${item.TIP_ARTICOL_OFERTA}', '${item.SUBTIP_ARTICOL_OFERTA}', '${item.NIVEL_OFERTA_1}', '${item.NIVEL_OFERTA_2}', '${item.NIVEL_OFERTA_3}', '${item.NIVEL_OFERTA_4}', '${item.NIVEL_OFERTA_5}', '${item.NIVEL_OFERTA_6}', '${item.NIVEL_OFERTA_7}', '${item.NIVEL_OFERTA_8}', '${item.NIVEL_OFERTA_9}', '${item.NIVEL_OFERTA_10}', '${item.UM_ARTICOL_OFERTA}', '${item.CANTITATE_ARTICOL_OFERTA}', '${item.COST_UNITAR_MATERIALE_ARTICOL_OFERTA}', '${item.COST_UNITAR_MANOPERA_ARTICOL_OFERTA}', '${item.COST_UNITAR_UTILAJE_ARTICOL_OFERTA}', '${item.COST_UNITAR_TRANSPORT_ARTICOL_OFERTA}', '${item.NORMA_UNITARA_ORE_MANOPERA_ARTICOL_OFERTA}', '${item.COST_UNITAR_ARTICOL_OFERTA}', '${item.COST_TOTAL_MATERIALE_ARTICOL_OFERTA}', '${item.COST_TOTAL_MANOPERA_ARTICOL_OFERTA}', '${item.COST_TOTAL_UTILAJE_ARTICOL_OFERTA}', '${item.COST_TOTAL_TRANSPORT_ARTICOL_OFERTA}', '${item.COST_TOTAL_ARTICOL_OFERTA}', '${item.TOTAL_ORE_MANOPERA_ARTICOL_OFERTA}', '${item.PRET_UNITAR_MATERIALE_ARTICOL_OFERTA}', '${item.PRET_UNITAR_MANOPERA_ARTICOL_OFERTA}', '${item.PRET_UNITAR_UTILAJE_ARTICOL_OFERTA}', '${item.PRET_UNITAR_TRANSPORT_ARTICOL_OFERTA}', '${item.PRET_UNITAR_ARTICOL_ARTICOL_OFERTA}', '${item.PRET_TOTAL_MATERIALE_ARTICOL_OFERTA}', '${item.PRET_TOTAL_MANOPERA_ARTICOL_OFERTA}', '${item.PRET_TOTAL_UTILAJE_ARTICOL_OFERTA}', '${item.PRET_TOTAL_TRANSPORT_ARTICOL_OFERTA}', '${item.PRET_TOTAL_ARTICOL_ARTICOL_OFERTA}');`
    )
  })

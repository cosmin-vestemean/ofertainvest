export const tables = {
  ...
  estimariTab: {
    element: document.getElementById('estimariTab'),
    visible: true,
  },
  allTables() {
      return [this.my_table1, this.my_table2, this.my_table3, this.my_table4, this.my_table5, this.my_table6, this.my_table7, this.my_table8, this.estimari_timeline, this.estimariTab];
  },

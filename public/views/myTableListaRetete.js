                        ...
                        <thead>
                          <tr>
                            ${Object.keys(visibleRecipeSubsDisplayMask).map(
                              (key) => html`<th style="width: 5%;"></th><th>${visibleRecipeSubsDisplayMask[key].label || key}</th>`
                            )}
                          </tr>
                        </thead>
                        <tbody>
                          ${item.subarticole.map(
                            (sub) => html`
                              <tr>
                                ${Object.keys(visibleRecipeSubsDisplayMask).map((key) => html`<td style="width: 5%;"></td><td>${sub[key]}</td>`)}
                              </tr>
                            `
                          )}
                        </tbody>

...
import { newTree, addOnChangeEvt, delimiter, ierarhii, flatFind, my_table5, selected_ds, template, my_table1, my_table2, my_table3, my_table4, my_table6, _start_date, _end_date } from "./client";
...
export class listaEstimari extends LitElement {
  ...
  render() {
    ...
    if (!this.ds || this.ds.length == 0) {
      ...
      button.innerHTML = <i class="bi bi-plus-square"></i>;
